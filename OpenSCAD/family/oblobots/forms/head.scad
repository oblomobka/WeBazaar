...
d1_head=lim(d1_head_minmax[0],head[0],d1_head_minmax[1]);		// medida de la cabeza: diámetro de base del cono
d2_head=lim(d2_head_minmax[0],head[1],2*h_head+d1_head);		// medida de la cabeza: diámetro de la punta del cono
