...
PRYM_SNAP_FASTENERS_11 = [10.1, 1.4, 3.5, 3, 9.1, 1,2,2.5,3.8];	// marca PRYM - Snap fasteners 11mm (boton para coser)
PRYM_SNAP_FASTENERS_9 = [8.5,1.5,3,2.7,8.1,1,2];	// marca PRYM - Snap fasteners 9mm  (boton para coser)
